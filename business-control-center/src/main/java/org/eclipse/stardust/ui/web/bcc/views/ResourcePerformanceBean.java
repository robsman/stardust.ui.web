...
public class ResourcePerformanceBean extends UIComponentBean implements ResourcePaths, ViewEventHandler, ITableDataFilterListener
{
   ...
   public void applyFilter(TableDataFilters tableDataFilters)
   {
      ...
      if (filter.isShowDatePicker())
      {
         ...
         columnDefinition = CustomColumnUtils.updateCustomColumnJson(columnId, columnTitle, startDate, endDate,
               columnDefinition, customColumnDateRange);
      }
      else
      {
         ...
         columnDefinition = CustomColumnUtils.updateCustomColumnJson(columnId, columnTitle,
               Integer.valueOf(startDateNumDays), startDateType, Integer.valueOf(durationNumDays), durationType,
               columnDefinition, customColumnDateRange);
      }
      List<String> allColumns = getCustomColumnsPreference();
