...
public class StrandedActivitiesResource
{
    ...
    */
   /*
    * @GET public Response getStrandedActivities() { try { QueryResultDTO result =
    * strandedActivitiesService.getStrandedActivities(); return
    * Response.ok(result.toJson(), MediaType.TEXT_PLAIN_TYPE).build(); } catch (Exception
    * e) { trace.error(e, e); return Response.serverError().build(); } }
    */
