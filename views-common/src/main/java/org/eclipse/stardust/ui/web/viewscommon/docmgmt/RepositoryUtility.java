...
public class RepositoryUtility
{
   ...
   {
      // create Reports Node
      DefaultMutableTreeNode reportsNode = createVirtualNode(I18nFolderUtils.getLabel(I18nFolderUtils.REPORTS),
            ResourcePaths.I_FOLDER, null);
      reportsNode.add(createPredefinedReportNode());
      reportsNode.add(createReportDesignsNode());
      reportsNode.add(createArchivedReportsNode());
   ...
   public static DefaultMutableTreeNode createSubfolder(DefaultMutableTreeNode parentNode, String folderName)
   {
      ...
      parentNode.setAllowsChildren(true);
      RepositoryFolderUserObject parentUserObject = (RepositoryFolderUserObject) parentNode.getUserObject();
      DefaultMutableTreeNode subNode = createFolderNode(DocumentMgmtUtility.createFolder(parentUserObject.getFolder()
            .getPath(), folderName));
      parentNode.add(subNode);
