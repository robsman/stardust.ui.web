...
public class Observers<O>
{
    ...
    */
   private volatile List<O> observers = Collections.emptyList();
    ...
    */
   public synchronized void add(O observer)
   {
      ...
      // atomic assignment
      this.observers = Collections.unmodifiableList(newObservers);
   }
   ...
   public <E extends AbstractEvent<O>> void notifyObservers(E event)
   {
