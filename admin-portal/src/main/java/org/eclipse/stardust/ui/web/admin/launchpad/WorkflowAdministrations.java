 ...
 * @version $Revision: $
 */
public class WorkflowAdministrations extends AbstractLaunchPanel implements ResourcePaths
{

   /**
    * @param name
    */
   public WorkflowAdministrations()
   {
      super(LP_workflowAdministrations);
      setExpanded(true);
   }
