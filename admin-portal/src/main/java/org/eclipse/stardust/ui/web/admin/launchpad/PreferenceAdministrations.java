 ...
 * @version $Revision: $
 */
public class PreferenceAdministrations extends AbstractLaunchPanel implements ResourcePaths
{

   /**
    * @param name
    */
   public PreferenceAdministrations()
   {
      super(LP_preferenceAdministrations);
      setExpanded(true);
   }
