 ...
 * @version $Revision: $
 */
public class DocumentRepositoryAdministrations extends AbstractLaunchPanel implements ResourcePaths
{

   /**
    * @param name
    */
   public DocumentRepositoryAdministrations()
   {
      super(LP_docRepoAdministrations);
      setExpanded(true);
   }
