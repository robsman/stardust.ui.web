...
(function() {
	...
	Controller.prototype.fetchPreference = function (){
		var self = this;
		var preferenceStore =  _sdPreferenceService.getStore(scope, moduleId, preferenceId)
		return preferenceStore.init().then(function(){
			config = preferenceStore;
			FAX_NUMBER_FORMAT = self.geFaxNumberFormat()
		});
	}
