 ...
 * 
 */
public abstract class AbstractMenuSection extends AbstractUiElement
{
   /**
    * 
    */
   public AbstractMenuSection(String name)
   {
      super(name);
   }
   ...
   {
      return new UiElementMessage(UiElementType.MENU_SECTION, name);
   }
}