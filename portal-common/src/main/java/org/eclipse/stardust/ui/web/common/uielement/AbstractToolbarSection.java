 ...
 * 
 */
public abstract class AbstractToolbarSection extends AbstractUiElement
{
   /**
    * 
    */
   public AbstractToolbarSection(String name)
   {
      super(name);
   }
   ...
   {
      return new UiElementMessage(UiElementType.TOOLBAR_SECTION, name);
   }
}