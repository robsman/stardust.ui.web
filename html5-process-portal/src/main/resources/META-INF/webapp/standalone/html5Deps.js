  ...
  function prepareRequireJsConfig(config) {
    var reqMod = {
      paths : {
        ...
        'html5ProcessPortalMain' : [ 'html5-process-portal/scripts/main' ],
      ...
      shim : {
		...
		'html5ProcessPortalMain' : ['html5CommonMain'],
        ...
        'sdNotesPanel':['html5ProcessPortalMain','sdUtilService', 'sdDateTimeFilter'],
        'sdProcessDocumentsPanel':['html5ProcessPortalMain','sdUtilService', 'sdMimeTypeService', 'sdPopover', 'sdRepositoryUploadDialog'],
        'sdMimeTypeService': ['html5ProcessPortalMain'],
        ...
        'sdVersionHistoryDialog': ['html5ViewsCommonMain','documentRepositoryService'],
        ...
        'sdOpenDocumentLink' : ['html5ProcessPortalMain','sdUtilService','sdCommonViewUtilService','sdMimeTypeService'],
        'sdProcessSummary':['html5ProcessPortalMain','sdUtilService', 'sdMimeTypeService', 'sdPopover'],
