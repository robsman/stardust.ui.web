...
public class TestMakerChecker extends RecordingTestcase
{
   ...
   @Test
   public void testCreateUserExclusions() throws Exception
   {
      ...
      replay(requestStream, "testCreateUserExclusions");
      ...
      EventHandlerType eventHandler = assertEventHandler(activity, "_excludeUser_", "_excludeUser_", PredefinedConstants.ACTIVITY_ON_ASSIGNMENT_CONDITION, false);
      assertThat(eventHandler.getEventAction(), is(not(nullValue())));
      assertThat(eventHandler.getEventAction().size(), is(6));
      assertExcludeUserAction(eventHandler, "FirstUserExclusion", "FirstUserExclusion", "PrimitiveData1", "aDataPath");
      assertExcludeUserAction(eventHandler, "SecondUserExclusion", "SecondUserExclusion", "PrimitiveData1", "aDataPath");
      assertExcludeUserAction(eventHandler, "SecondUserExclusion1", "SecondUserExclusion", "PrimitiveData1", "aDataPath");
      assertExcludeUserAction(eventHandler, "NoDataPathUserExclusion", "NoDataPathUserExclusion", "PrimitiveData1", null);
      assertExcludeUserAction(eventHandler, "ExcludeUser", "Exclude User", "PrimitiveData1", "aDataPath");
      assertExcludeUserAction(eventHandler, "ExcludeUser1", "Exclude User 1", "PrimitiveData1", "aDataPath");

   }

   @Test
   public void testUpdateUserExclusions() throws Exception
   {
      providerModel = modelService.findModel(PROVIDER_MODEL_ID);
      ...
      replay(requestStream, "testUpdateUserExclusions");
      ...
      assertThat(activity.getEventHandler(), is(not(nullValue())));
      assertThat(activity.getEventHandler().size(), is(1));
      EventHandlerType eventHandler = assertEventHandler(activity, "_excludeUser_", "_excludeUser_", PredefinedConstants.ACTIVITY_ON_ASSIGNMENT_CONDITION, true);
      assertThat(eventHandler.getEventAction(), is(not(nullValue())));
      assertThat(eventHandler.getEventAction().size(), is(6));
      assertExcludeUserAction(eventHandler, "RenamedExclusion", "Renamed Exclusion", "PrimitiveData1", "aDataPath");
      assertExcludeUserAction(eventHandler, "RenamedExclusion1", "Renamed Exclusion", "PrimitiveData1", null);
      assertExcludeUserAction(eventHandler, "SecondUserExclusion1", "SecondUserExclusion", "PROCESS_ID", "aDataPath");
      assertExcludeUserAction(eventHandler, "AddedDataPathExclusion", "AddedDataPathExclusion", "PrimitiveData1", "addedDataPath");
      assertExcludeUserAction(eventHandler, "ExcludeUser", "Exclude User", "PrimitiveData1", "aDataPath");
      assertExcludeUserAction(eventHandler, "ExcludeUser1", "Exclude User 1", "PrimitiveData1", "aDataPath");
   ...
   @Test
   public void testDeleteUserExclusions() throws Exception
   {
      providerModel = modelService.findModel(PROVIDER_MODEL_ID);
      ...
      replay(requestStream, "testDeleteUserExclusions");
   ...
   public static EventActionType assertExcludeUserAction(EventHandlerType eventHandler, String id, String name, String data, String dataPath)
   {
      EventActionType eventAction = assertEventAction(eventHandler, id, name, PredefinedConstants.EXCLUDE_USER_ACTION);
      GenericModelingAssertions.assertAttribute(eventAction, PredefinedConstants.EXCLUDED_PERFORMER_DATA, data);
      GenericModelingAssertions.assertAttribute(eventAction, PredefinedConstants.EXCLUDED_PERFORMER_DATAPATH, dataPath);
      return eventAction;
   }
