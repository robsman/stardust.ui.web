...
define(
                  ...
                  m_i18nUtils)
         {
            ...
            function MessageEventIntegrationOverlay()
            {
                ...
                * 
                */
               MessageEventIntegrationOverlay.prototype.initialize = function(page, id)
               {
                  this.initializeEventIntegrationOverlay(page, id);

                  m_utils
                           .jQuerySelect("label[for='nameInput']")
                           .text(
                                    m_i18nUtils
                                             .getProperty("modeler.element.properties.messageEvent.name"));
                  m_utils
                           .jQuerySelect("label[for='typeSelect']")
                           .text(
                                    m_i18nUtils
                                             .getProperty("modeler.element.properties.messageEvent.type"));

                  m_utils
                           .jQuerySelect("label[for='preserveQoSInput']")
                           .text(
                                    m_i18nUtils
                                             .getProperty("modeler.element.properties.messageEvent.preserveQoS"));
                  m_utils
                           .jQuerySelect("label[for='selector']")
                           .text(
                                    m_i18nUtils
                  ...
                  this.producerBpmTypeConverter = jQuery("#messageEvent #converterSettingsTab #producerBpmTypeConverter");
                  this.producerInboundConversion = jQuery("#messageEvent #converterSettingsTab #producerInboundConversion");
                  this.producerInboundConverterDelimiterInput = jQuery("#messageEvent #converterSettingsTab #producerInboundConverterDelimiterInput");

                  this.fromXmlParameters = jQuery("#messageEvent #converterSettingsTab #fromXmlParameters");
                  this.fromXmlParameters.hide();
                  this.fromJsonParameters = jQuery("#messageEvent #converterSettingsTab #fromJsonParameters");
                  this.fromJsonParameters.hide();
                  this.fromCsvParameters = jQuery("#messageEvent #converterSettingsTab #fromCsvParameters");
                  ...
                  this.parameterDefinitionNameInput = jQuery("#messageEvent #parametersTab #parameterDefinitionNameInput");
               ...
               MessageEventIntegrationOverlay.prototype.getEndpointUri = function()
               {
                  ...
                  if (this.jmsComponentIdInput.val() != null
                           && this.jmsComponentIdInput.val().length != 0)
                  {
                  ...
                  if (this.clientIdInput.val() != null
                           && this.clientIdInput.val().length != 0)
                  {
                     uri += separator + "clientId="
                              + encodeURIComponent(this.clientIdInput.val());
                     separator = "&amp;";
                  }

                  if (this.selectorInput.val() != null
                           && this.selectorInput.val().length != 0)
                  {
                     uri += separator + "selector="
                              + encodeURIComponent(this.selectorInput.val());
                     separator = "&amp;";
                  }
               ...
               MessageEventIntegrationOverlay.prototype.showConverterOptions = function(
                        panel)
               {
               ...
               MessageEventIntegrationOverlay.prototype.hideConverterOptions = function(
                        panel)
               {
                  ...
                  if (uri)
                  {
                     ...
                     if (sourceAndProperties[1] != null)
                     {
                        ...
                        for (var n = 0; n < nameValues.length; ++n)
                        {
                           ...
                           {
                              this.preserveQoSInput.prop("checked", value == "true");
                           }
                        }
                     }/* end URI parsing */
                  }
               ...
               MessageEventIntegrationOverlay.prototype.validate = function()
               {
                  ...
                  if (m_utils.isEmptyString(this.jmsComponentIdInput.val())
                           || this.jmsComponentIdInput.val() == m_i18nUtils
                                    .getProperty("modeler.general.toBeDefined"))
                  {
                     this.getPropertiesPanel().errorMessages.push(m_i18nUtils
                  ...
                  for (var n = 0; n < this.page.getEvent().parameterMappings.length; n++)
                  {
                	  ...
                	  if ((ap.name.replace(/ /g, "") == "headers")||(ap.name.replace(/ /g, "") == "exchange")||(ap.name.replace(/ /g, "") == "headers"))
                	  {
