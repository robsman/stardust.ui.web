...
window.Raphael.svg && function (R) {
    ...
    tuneText = function (el, params) {
        ...
        var a = el.attrs,
            node = el.node,
            fontSize = node.firstChild ? (R._g.doc.defaultView.getComputedStyle(node.firstChild, E) ? toInt(R._g.doc.defaultView.getComputedStyle(node.firstChild, E).getPropertyValue("font-size"), 10) : 10) : 10;
