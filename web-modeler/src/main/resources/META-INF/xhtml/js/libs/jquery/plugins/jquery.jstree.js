...
(function ($) {
	$.vakata.context = {
		...
		exec	: function (i) {
			if($.isFunction($.vakata.context.func[i])) {
				// Patched to add the function name as a parameter
	...
	$(function () {
		var css_string = '' + 
			'#vakata-contextmenu { display:block; position:absolute; margin:0; padding:0; min-width:100px; background:#ebebeb; border:1px solid silver; z-index:10000; *width:100px; } ' + 
