...
if (!window.bpm.portal.modelerRequire) {
	bpm.portal.modelerRequire = {
		PATHS : {
			...
			'jquery.jqprint' : [
					'bpm-modeler/js/libs/jquery/plugins/jquery.jqprint-0.3',
					'https://raw.github.com/tanathos/jquery.jqprint/master/jquery.jqprint-0.3' ],

			'jslint' : [
					'bpm-modeler/js/libs/jslint/jslint',
					'https://raw.github.com/douglascrockford/JSLint/996246308b755df665bd6c4f3ae59d655ae0a97e/jslint' ],
			'ace' : [ 'bpm-modeler/js/libs/ace/ace',
