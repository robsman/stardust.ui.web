      ...
      function(m_utils, m_i18nUtils, m_constants,m_dialog, m_commandsController,
         ...
         function RestServiceOverlay() {
            ...
            RestServiceOverlay.prototype.initialize = function(view) {
               ...
               this.authenticationPreemptiveInput= m_utils.jQuerySelect("#securityTab #authenticationPreemptiveInput");
               this.authenticationPreemptiveInput.hide();
               this.authenticationPreemptiveLabel= m_utils.jQuerySelect("#securityTab #authenticationPreemptiveLabel");
               ...
               if(this.getApplication().attributes["stardust:restServiceOverlay::authenticationPreemptive"]==null)
                  {
                  
                  this.view
                  .submitChanges({
                     attributes : {
                        "stardust:restServiceOverlay::authenticationPreemptive" : true
...
//                );
            ...
            RestServiceOverlay.prototype.getRoute = function() {
               ...
               if (this.securityModeSelect.val() === "httpBasicAuth")
               {
                  ...
                  if (this.authenticationPreemptiveInput.prop("checked"))
            ...
            RestServiceOverlay.prototype.update = function() {
               ...
               this.authenticationPreemptiveInput.prop("checked", this.getApplication().attributes["stardust:restServiceOverlay::authenticationPreemptive"]);
               ...
               this.view
                     .submitChanges({
                        attributes : {
                           ...
                           "stardust:restServiceOverlay::authenticationPreemptive" : this.authenticationPreemptiveInput.prop("checked") 
                           ? this.authenticationPreemptiveInput.prop("checked") : false,
