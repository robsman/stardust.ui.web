...
public class ModelerResource
{
   ...
   @Produces(MediaType.APPLICATION_JSON)
   @Path("models/{modelId}")
   public Response deleteModel(@PathParam("modelId") String modelId, String postedData)
   {
      try
      {
         JsonObject json = jsonIo.readJsonObject(postedData);
         ...
         @PathParam("processId") String processId, String postedData)
   {
      ...
      {
         JsonObject json = jsonIo.readJsonObject(postedData);
         String result = getModelService().deleteProcess(modelId, processId, json);
         return Response.ok(result, MediaType.APPLICATION_JSON_TYPE).build();
      }
      catch (Exception e)
      {
   ...
   public Response deleteStructuredDataType(@PathParam("modelId") String modelId,
         ...
         @PathParam("id") String participantId, String postedData)
   {
      ...
      {
         JsonObject json = jsonIo.readJsonObject(postedData);
         String result = getModelService().deleteParticipant(modelId, participantId, json);
         return Response.ok(result, MediaType.APPLICATION_JSON_TYPE).build();
      }
      catch (Exception e)
      {
         ...
         @PathParam("applicationId") String applicationId, String postedData)
   {
      ...
      {
         JsonObject json = jsonIo.readJsonObject(postedData);
         String result = getModelService().deleteApplication(modelId, applicationId, json);
         return Response.ok(result, MediaType.APPLICATION_JSON_TYPE).build();
      }
      catch (Exception e)
      {
