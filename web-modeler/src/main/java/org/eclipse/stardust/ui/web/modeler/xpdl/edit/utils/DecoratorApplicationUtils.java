...
public class DecoratorApplicationUtils
{
         ...
         ApplicationType application, ModelBuilderFacade modelBuilderFacade)
   {
      ...
      if (StringUtils.isNotEmpty(elementId) && StringUtils.isNotEmpty(elementType)
            && StringUtils.isNotEmpty(modelId)
            )
      {
         ...
         ModelType providerModel = ModelUtils.findContainingModel(decoratedApplication);
