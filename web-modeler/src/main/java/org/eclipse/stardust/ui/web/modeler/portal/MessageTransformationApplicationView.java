...
@Component
public class MessageTransformationApplicationView implements ViewEventHandler {
	...
	public void handleEvent(ViewEvent event) {
		...
		pagePath += "/plugins/bpm-modeler/views/modeler/messageTransformationApplicationPanel.xhtml";
		...
		case TO_BE_ACTIVATED:
			...
			PortalApplication.getInstance().addEventScript("InfinityBpm.ProcessPortal.createOrActivateContentFrame('" + iframeId + "', '" + pagePath + event.getView().getParams() + "', {anchorId:'messageTransformationApplicationPanelAnchor', width:1000, height:800, maxWidth:1000, maxHeight:1000, anchorYAdjustment:10, zIndex:200});");
