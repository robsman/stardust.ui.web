...
public class XpdlModelingUiExtensions implements ModelerUiExtensionsProvider
{
   ...
   public List<ToolbarEntryConfiguration> getToolbarEntryConfigs()
   {
      return asList(
            ...
            new ToolbarEntryConfiguration("undoButton", "drawingPalette", "Undo",
                  "../../images/icons/undo.png", "m_defaultPaletteHandler", "undo", "always"),
            new ToolbarEntryConfiguration("redoButton", "drawingPalette", "Redo",
                  "../../images/icons/redo.png", "m_defaultPaletteHandler", "redo", "always"),
