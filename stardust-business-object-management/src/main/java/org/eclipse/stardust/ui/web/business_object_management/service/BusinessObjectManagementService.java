...
public class BusinessObjectManagementService {
    ...
    */
    ...
    private JsonObject toJson(Data data, TypedXPath xPath, int modelOid) {
        ...
        addStructuralInformation(json, xPath.getChildXPaths(), types, pkAttribute);
    ...
    private JsonObject toJson(TypedXPath xPath, JsonObject types, String pkAttribute) {
