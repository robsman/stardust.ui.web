...
@Component
@Scope("session")
public class BenchmarkPerspective extends AbstractLaunchPanel
		implements PerspectiveEventHandler {

	private static final Logger trace = LogManager
			.getLogger(BenchmarkPerspective.class);
    ...
    *
    */
	public BenchmarkPerspective() {
		super("benchmarkPerspective");
    ...
    */
	private static void deActivateIframe() {
		String deActivateIframeJS = "InfinityBpm.ProcessPortal.deactivateContentFrame('benchmarkLaunchPanelFrame');";
    ...
    */
	private static void activateIframe() {
		String outlinePath = FacesContext.getCurrentInstance()
				...
				+ "/plugins/benchmark/launchpanel/benchmarkLaunchPanel.html";
		String activateIframeJS = "InfinityBpm.ProcessPortal.createOrActivateContentFrame('benchmarkLaunchPanelFrame', '"
				+ outlinePath
				+ "', {anchorId:'portalLaunchPanels:benchmarkLaunchPanelAnchor', autoResize: true, heightAdjustment: -40, zIndex:800, noUnloadWarning: 'true', frmAttrs: {repotitionOnScroll: false}});";
