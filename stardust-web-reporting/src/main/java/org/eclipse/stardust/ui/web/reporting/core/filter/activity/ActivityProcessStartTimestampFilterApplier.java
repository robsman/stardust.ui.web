...
public class ActivityProcessStartTimestampFilterApplier extends DimensionBasedFilterApplier<ActivityInstanceQuery>
{

   @Override
   protected String getMatchDimension()
   {
      return Constants.AiDimensionField.PROCESS_INSTANCE_START_TIMESTAMP.getId();
   }
