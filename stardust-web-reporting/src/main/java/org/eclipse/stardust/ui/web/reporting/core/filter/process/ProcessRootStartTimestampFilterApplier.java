...
public class ProcessRootStartTimestampFilterApplier extends DimensionBasedFilterApplier<ProcessInstanceQuery>
{
   @Override
   protected String getMatchDimension()
   {
      return Constants.PiDimensionField.ROOT_START_TIMESTAMP.getId();
   }
