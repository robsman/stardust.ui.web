...
public class ActivityStartTimeStampFilterapplier extends DimensionBasedFilterApplier<ActivityInstanceQuery>
{

   @Override
   protected String getMatchDimension()
   {
      return Constants.AiDimensionField.START_TIMESTAMP.getId();
   }
