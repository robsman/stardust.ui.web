...
public class ProcessTerminationTimestampFilterApplier extends DimensionBasedFilterApplier<ProcessInstanceQuery>
{
   @Override
   protected String getMatchDimension()
   {
      return Constants.PiDimensionField.TERMINATION_TIMESTAMP.getId();
   }

   @Override
   public void apply(ProcessInstanceQuery query, ReportFilter filter)
   {
      applyDateFilter(query, ProcessInstanceQuery.TERMINATION_TIME, filter);
   }
}
