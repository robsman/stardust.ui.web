...
import org.eclipse.stardust.ui.web.reporting.beans.spring.ModelServiceBean;
 ...
 * 
 *         TODO: This is a copy of ViewsCommon#XPathCacheManager. Review and move to the
 *         common place later
 */
@Component(value = XPathCacheManager.BEAN_ID)
...
public class XPathCacheManager
{
   ...
   public static final String BEAN_ID = "ippXPathCacheManager_spring";
   ...
   private Model getReferenceModel(Model model, DataPath dp)
   {
      ...
      if (ref != null)
      {
         refModel = modelService.getModel(ref.getModelOid());
      }
      else
      {
         ...
         refModel = modelService.getModel(data.getModelOID());
      }
