...
public class AiOidColumnHandler extends AiColumnHandler<Long>
{
   @Override
   ...
   {
      return new DataField(AiDimensionField.OID.getId(),
   ...
   {
      applyOidFilter(query, ActivityInstanceQuery.OID, filter, parameter);
   }
}
