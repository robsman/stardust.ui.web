...
public class PiTerminationTimestampColumnHandler extends PiColumnHandler<Date>
{
   @Override
   ...
   {
      applyDateFilter(query, ProcessInstanceQuery.TERMINATION_TIME, filter, parameter);
   }
}
