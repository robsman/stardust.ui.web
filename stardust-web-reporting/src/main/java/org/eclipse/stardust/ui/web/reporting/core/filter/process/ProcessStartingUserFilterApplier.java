...
//      JsonArray jsonArray = filter.getValue().getAsJsonArray();
//      for(JsonElement filterElement : jsonArray)
//      {
//         JsonObject jsonObject = filterElement.getAsJsonObject();
//         @SuppressWarnings("unused")
//         String userId = jsonObject.getAsJsonPrimitive("id").getAsString();
//         String userName = jsonObject.getAsJsonPrimitive("name").getAsString();
//
//
//
//      }
