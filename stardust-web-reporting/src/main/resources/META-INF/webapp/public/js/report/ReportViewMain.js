require
		.config({
			waitSeconds: 0,
			baseUrl : "http://localhost:8080/idemo/plugins/",
			paths : {
				...
				'jquery-ui-timepicker' : ['bpm-reporting/public/js/libs/jquery/plugins/jquery-ui-timepicker/jquery-ui-timepicker-addon.min'],				
