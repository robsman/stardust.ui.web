								...
								template : '<table ng-show="showError" style="width : 100%;">'
										+ '<tr>'
											+ '<td style="width : 1em ; align:center">'
												+ '<i ng-if="type == \'error\'" class="pi pi-stop msg-{{type}}"></i>'
												+ '<i ng-if="type == \'info\'" class="pi pi-info msg-{{type}}"></i>'
												+ '<i ng-if="type == \'warn\'" class="pi pi-exclamation-triangle msg-{{type}}"></i>'
												+ '<i ng-if="type == \'ok\'" class="pi pi-check-box-checked" ></i>'
											+ '</td>'
