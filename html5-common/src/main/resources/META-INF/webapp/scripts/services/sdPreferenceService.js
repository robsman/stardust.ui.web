...
(function() {
	...
	function PreferenceService(sdUtilService, sdLoggerService, $resource) {
		...
		function PreferenceStorage(scope, module, preferenceId) {
			 ...
			 *
			 */
			PreferenceStorage.prototype.getValueOld = function(name, fromParent) {
				if (this.store == undefined) {
					this.fetch();
				}
			 ...
			 *
			 */
			PreferenceStorage.prototype.saveAndReload = function() {
				var self = this;
				if (this.store != undefined) {
					return self.save().then(self.init());
				} else {
			 ...
			 *
			 */
			PreferenceStorage.prototype.saveOld = function() {
				if (this.store != undefined) {
