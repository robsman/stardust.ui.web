...
require([ "require", "jquery", "jquery-ui", "jquery.tablescroll",
		"jquery.treeTable", "jquery.url", "jquery.ba-outside-events",
		"bpm-modeler/js/m_extensionManager", "common-plugins", "i18n",
		"rules-manager/js/RuleView" ], function(require) {
	require("rules-manager/js/RuleView").initialize(
			BridgeUtils.View.getActiveViewParams().param("ruleSetUuid"),
